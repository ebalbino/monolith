...
impl Clock {
    ...
    pub fn update(&self) {
        ...
        self.delta_nanoseconds
            .set(delta_ticks / self.ticks_per_second);
        self.delta_microseconds
            .set(self.delta_nanoseconds() / 1_000);
        self.delta_milliseconds
            .set(self.delta_microseconds() / 1_000);
        self.delta_seconds
            .set(self.delta_milliseconds() as f64 / 1_000.0);
